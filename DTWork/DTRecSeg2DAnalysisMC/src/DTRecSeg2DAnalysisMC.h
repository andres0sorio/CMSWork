// -*- C++ -*-
//
// Package:    DTRecSeg2DAnalysisMC
// Class:      DTRecSeg2DAnalysisMC
// 
/**\class DTRecSeg2DAnalysisMC DTRecSeg2DAnalysisMC.cc DTWork/DTRecSeg2DAnalysisMC/src/DTRecSeg2DAnalysisMC.cc
...
class DTRecSeg2DAnalysisMC : public edm::EDAnalyzer {
public:
  
  explicit DTRecSeg2DAnalysisMC(const edm::ParameterSet&);
  ~DTRecSeg2DAnalysisMC();
...
private:
  ...
  TH1D * h_tseg_st2_sec1_w0;
  TH1D * h_t0seg_st1;
  TH1D * h_t0seg_st2;
  TH1D * h_t0seg_st3;
  TH1D * h_t0seg_st4;
  TH1D * h_t0seg_st2_sec1_w0;
