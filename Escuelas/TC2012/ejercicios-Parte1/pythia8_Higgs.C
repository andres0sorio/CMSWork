void pythia8_Higgs() {
  ...
  pythia8->ReadString("HiggsSM:XXXX = on");
  ...
  pythia8->ReadString("25:m0 = XXX.0"); //masa del Higgs <- Cambiar a la masa sugerida
  ...
  //Ejercicio 4: queremos que Z-> q qbar y H0-> b bbar
  //Adicione aqui las lineas necesarias
