...
// Tue May 22 16:55:06 2012 by ROOT version 5.28/00
// from TTree tree/Arbol con particulas segun Pythia8
// found on file: eventos_pythia8_SUSY.root
//////////////////////////////////////////////////////////

#ifndef MyFirstROOTclass_h
#define MyFirstROOTclass_h

#include <TROOT.h>
#include <TChain.h>
#include <TFile.h>
   const Int_t kMaxparticles = 3015;

class MyFirstROOTclass {
public :
   ...
   MyFirstROOTclass(TTree *tree=0);
   virtual ~MyFirstROOTclass();
...
#ifdef MyFirstROOTclass_cxx
MyFirstROOTclass::MyFirstROOTclass(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("eventos_pythia8_SUSY.root");
      if (!f) {
         f = new TFile("eventos_pythia8_SUSY.root");
      }
...
MyFirstROOTclass::~MyFirstROOTclass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MyFirstROOTclass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MyFirstROOTclass::LoadTree(Long64_t entry)
{
...
void MyFirstROOTclass::Init(TTree *tree)
{
...
Bool_t MyFirstROOTclass::Notify()
{
...
void MyFirstROOTclass::Show(Long64_t entry)
{
...
Int_t MyFirstROOTclass::Cut(Long64_t entry)
{
...
#endif // #ifdef MyFirstROOTclass_cxx
