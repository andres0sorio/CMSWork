...
process.maxEvents = cms.untracked.PSet( input = cms.untracked.int32(34457) )
...
process.hltBeamHalo = cms.EDFilter("HLTHighLevel",
                                   ...
                                   HLTPaths = cms.vstring('HLT_CSCBeamHalo','HLT_CSCBeamHaloOverlapRing1',
                                                          'HLT_CSCBeamHaloOverlapRing','HLT_CSCBeamHaloRing2or3'),
...
process.HLTDT =cms.EDFilter("HLTHighLevel",
                            TriggerResultsTag = cms.InputTag("TriggerResults","","HLT"),
                            HLTPaths = cms.vstring('HLT_L1MuOpen','HLT_Activity_DT'),
                            eventSetupPathsKey = cms.string(''),
                            andOr = cms.bool(True),
                            throw = cms.bool(False)                             )
...
#process.outpath = cms.EndPath(process.recotrackout+process.outputBeamHaloSkim+process.bscnobhout)
#process.outpath = cms.EndPath(process.bscnobhout)
