...
globaltag = 'GR10_P_V2::All'
inputfile = 'rfio:/castor/cern.ch/cms/store/caf/user/zgecse/ExpressPhysics/MuonSkimRun132440/f0601f8811b55c14db6d8c9933fe28c2/MuonSkim_1.root'
...
process.makeTtuSkim = cms.EDFilter('TTUSkim',
                                   ...
                                   LumiSection = cms.untracked.int32(165),
