...
void rootlogon(int option) {
  ...
  //Set the FWLite Framework and L1TriggerDPG classes
  ...
  //don't compile User Code for plotting (if already compiled)
  if (!option) {
