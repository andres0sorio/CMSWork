...
# with command line options: Configuration/Generator/ZMM_7TeV_cfi.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:GRun --conditions START38_V12::All --datatier GEN-SIM-RAW --eventcontent RAWSIM --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/Generator/ZMM_7TeV_cfi.py nevts:1'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step1_ZMM_RAW.root'),
