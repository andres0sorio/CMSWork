...
Interpolation::Interpolation( const char * f_name ) {
  ...
  m_interpolatorCC = new  ROOT::Math::Interpolator( m_xx, m_cc, ROOT::Math::Interpolation::kLINEAR);
  m_interpolatorNC = new  ROOT::Math::Interpolator( m_xx, m_nc, ROOT::Math::Interpolation::kLINEAR);
...
void Interpolation::showPointsCC() {
...
void Interpolation::showPointsNC() {
