...
public: 
  ...
  Integrals( Integrals & base ) {
    ...
    nu_xsec_derivator=base.nu_xsec_derivator;
    antinu_xsec_derivator=base.antinu_xsec_derivator;
  }; 
  ...
  Derivatives   * nu_xsec_derivator;

  Derivatives   * antinu_xsec_derivator;
