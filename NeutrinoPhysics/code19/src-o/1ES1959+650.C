...
void makePlots() {
  ...
  graphT4 = readTypeFour("1959-650-1ES-data/log-parabolas-fit-data-points-v3.txt");
  allgraphs->Add( graphT4 ); //Append to your List this Graph
  ndataset++;
	
	
//	graphT4 = readTypeFour("1959-650-1ES-data/output4");
	graphT4 = readTypeFour("1959-650-1ES-data/output7");
	allgraphs->Add( graphT4 ); //Append to your List this Graph
	ndataset++;
	
//	graphT4 = readTypeFour("1959-650-1ES-data/output5");	
	graphT4 = readTypeFour("1959-650-1ES-data/output7");
	allgraphs->Add( graphT4 ); //Append to your List this Graph
	ndataset++;	
	
	
	graphT4 = readTypeFour("1959-650-1ES-data/output12");
	allgraphs->Add( graphT4 ); //Append to your List this Graph
	ndataset++;	
