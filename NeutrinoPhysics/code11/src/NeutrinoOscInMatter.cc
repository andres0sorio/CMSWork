...
NeutrinoOscInMatter::NeutrinoOscInMatter(  ) : IProbabilityMatrix() {
  ...
  m_Qm   = new matrix< double >(3,3);
  initializeMatrix( m_Qm );
  
  m_evfactor = 5.076*1E6; // = (1/eV) = (1.97 10^-7)m : natural units [wikipedia]
...
double NeutrinoOscInMatter::sinTh_m( int i, int j )
{
...
double NeutrinoOscInMatter::cosTh_m( int i, int j )
{
...
double NeutrinoOscInMatter::sin2Q13m() 
{
  
  double result = ( sin( 2.0 * (*m_Q)(1-1,3-1) ) ) /
...
double NeutrinoOscInMatter::deltaMu21()
{

  double result = ( 0.5 * m_Dm23sq) * ( ( sin( 2.0 * (*m_Q)(1-1,3-1)) / sin( 2.0 * (*m_Qm)(1-1,3-1)) ) - 1.0)
    - ( m_Enu * m_Ve );
...
double NeutrinoOscInMatter::deltaMu32()
{
...
double NeutrinoOscInMatter::deltaMu31()
{
  
  double result = m_Dm23sq * ( ( sin( 2.0 * (*m_Q)(1-1,3-1)) / sin( 2.0 * (*m_Qm)(1-1,3-1)) ) );
  
  return result;
  
}

double NeutrinoOscInMatter::Sij(int i, int j)
{

  //
  if ( i==2 && j==1 )
    return pow( sin( deltaMu21() * m_L / ( 4.0 * m_Enu ) ) , 2.0 );

  //  
  if ( i==3 && j==2 )
    return pow( sin( deltaMu32() * m_L / ( 4.0 * m_Enu ) ) , 2.0 );

  //
  if ( i==3 && j==1 )
    return pow( sin( deltaMu31() * m_L / ( 4.0 * m_Enu ) ) , 2.0 );
...
void NeutrinoOscInMatter::calcProbabilities() 
{
  ...
  (*m_Prob_AtoB) (0,1) = 4.0 * pow( sinTh_m(1,3), 2.0) 
    * pow( cosTh_m(1,3), 2.0) * pow( sinTh(2,3), 2.0) * Sij(3,1);

  //(*m_Prob_AtoB) (0,2) = Pet ok
  (*m_Prob_AtoB) (0,2) = 4.0 * pow( sinTh_m(1,3), 2.0) 
    * pow( cosTh_m(1,3), 2.0) * pow( cosTh(2,3), 2.0) * Sij(3,1);
  ...
  //(*m_Prob_AtoB) (1,1) = Pmm
  (*m_Prob_AtoB) (1,1) = 1.0 
    - 4.0 * pow( sinTh_m(1,3), 2.0) * pow(cosTh_m(1,3), 2.0)
    * pow( sinTh(2,3), 4.0) * Sij(3,1)
    - 4.0 * pow( sinTh_m(1,3), 2.0) * pow(sinTh(2,3),2.0)
    * pow( cosTh(2,3), 2.0) * Sij(2,1)
    - 4.0 * pow( cosTh_m(1,3), 2.0) * pow(sinTh(2,3),2.0)
    * pow( cosTh(2,3), 2.0) * Sij(3,2);
  
  //(*m_Prob_AtoB) (1,2) = Pmt
  (*m_Prob_AtoB) (1,2) = - 4.0 * pow( sinTh_m(1,3), 2.0) * pow(cosTh_m(1,3),2.0)
    * pow( sinTh(2,3), 2.0) * pow( cosTh(2,3), 2.0) * Sij(3,1)
    + 4.0 * pow( sinTh_m(1,3), 2.0) * pow(sinTh(2,3),2.0)
    * pow( cosTh(2,3), 2.0) * Sij(2,1)
    + 4.0 * pow( cosTh_m(1,3), 2.0) * pow(sinTh(2,3),2.0)
    * pow( cosTh(2,3), 2.0) * Sij(3,2);
