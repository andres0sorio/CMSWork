...
runid      = options.runid
jobname    = 'ttu.L1GtAnal.' + runid

infile = runid + '/list_of_digis.txt'

app = cmsRun()
app.uselibs = 1
app.cfgfile = File(name='/afs/cern.ch/user/a/aosorio/scratch0/CMSSW_2_2_9/src/StudyL1Trigger/L1GtTtuAnalyzer/test/l1gtttuanalyzer_cfg.py')
