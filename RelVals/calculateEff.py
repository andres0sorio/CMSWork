...
h1_den = [['TrackParticle.Pt.TOB','','1','0','Pt [GeV/c]'],
...
h1_num = []
for k in tt_Bits:
	h1_num.append( [ tobprefix+'.' + str(k), '','1','0','Pt [GeV/c]' ] )
	h1_num.append( [ tecprefix+'.' + str(k), '','1','0','Pt [GeV/c]' ] )
	h1_num.append( [ toeprefix+'.' + str(k), '','1','0','Pt [GeV/c]' ] )
