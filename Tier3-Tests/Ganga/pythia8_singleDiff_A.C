...
void pythia8_singleDiff_A(Int_t nev  = 100) {
  ...
  TFile * outfile = new TFile("eventos_pythia8_singlediff.root","RECREATE");
  
  // Array of particles
  TClonesArray* particles = new TClonesArray("TParticle", 3000);
  ...
  pythia8->Initialize(2212 /* p */, -2212 /* pbar */, 1960. /* GeV */);
