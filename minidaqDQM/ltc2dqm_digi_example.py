...
process.source = cms.Source ("NewEventStreamFileReader",fileNames = readFiles, secondaryFileNames = secFiles) 
 
readFiles.extend( [ 
'rfio:/castor/cern.ch/cms/store/streamer/Minidaq/A/000/135/038/Minidaq.00135038.0001.A.storageManager.00.0000.dat' ] ) 
